...
# df = pd.read_csv('/Users/aashara/Documents/Study/Research Credit/Seasonal_Trends/Paper 2/Combined_Claims_3years.csv',dtype ='str')
...
print(df_symp_week.head())

print(type(df_symp_week))
...
# df_disease_symptom_group = df_symp_week.groupby(['ICD9_DGNS_CD_1', 'ADMTNG_ICD9_DGNS_CD']).size().reset_index(name='Prob_Sym_Dis_1')
#
...
# joined_df['Prob_Sym_Dis'] = (joined_df.Prob_Sym_Dis_1.astype(int)/reccount)
#
#
...
# joined_df['Prob_Dis_given_Sym_Week'] = (joined_df.Prob_Sym_Week_given_disease.astype('double') * joined_df.Prob_Dis.astype('double')) /(joined_df.Prob_Sym_Week.astype('double') )
#
