...
df_ben = pd.read_csv(
    '/Users/aashara/Documents/Study/Research Credit/Seasonal_Trends/Paper 2/DE1_0_2008_Beneficiary_Summary_File_Sample_2.csv',
    dtype='str')
...
df_clm = pd.read_csv(
    '/Users/aashara/Documents/Study/Research Credit/Seasonal_Trends/Paper 2/20 Sample Data /DE1_0_2008_to_2010_Inpatient_Claims_Sample_2.csv',
    dtype='str')
print(len(df_clm))
